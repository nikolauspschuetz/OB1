...
ALLOW_UNREAD=(
  ...
  GITHUB_TOKEN GITHUB_ORG GITHUB_REPO_ALLOWLIST
  LINEAR_API_KEY LINEAR_TEAM_ALLOWLIST
  CALENDAR_ICS_URL FIGMA_TOKEN FIGMA_FILE_ALLOWLIST
  NOTION_TOKEN NOTION_DATABASE_ALLOWLIST
)
