...
ALLOW_UNREAD=(
  ...
  DASHBOARD_PASSWORD DASHBOARD_SESSION_SECRET DASHBOARD_PORT DASHBOARD_SESSION_MAX_AGE
  OB1_COOKIE_DOMAIN
  SLACK_BOT_TOKEN SLACK_APP_TOKEN SLACK_ALLOWED_CHANNELS SLACK_BACKFILL_DAYS SLACK_POLL_SECONDS
  DASHBOARD_PUBLIC_URL SLACKBOT_LOG_LEVEL
  GMAIL_CLIENT_ID GMAIL_CLIENT_SECRET GMAIL_REFRESH_TOKEN GMAIL_QUERY
  GITHUB_TOKEN GITHUB_ORG GITHUB_REPO_ALLOWLIST GITHUB_BACKFILL_DAYS GITHUB_POLL_SECONDS GITHUB_INCLUDE_ISSUES GITHUB_INCLUDE_RELEASES
  LINEAR_API_KEY LINEAR_TEAM_ALLOWLIST LINEAR_INCLUDE_COMMENTS LINEAR_BACKFILL_DAYS LINEAR_POLL_SECONDS
  CALENDAR_ICS_URL CALENDAR_BACKFILL_DAYS CALENDAR_FORWARD_DAYS CALENDAR_POLL_SECONDS
  FIGMA_TOKEN FIGMA_FILE_ALLOWLIST FIGMA_POLL_SECONDS FIGMA_INCLUDE_VERSIONS
  NOTION_TOKEN NOTION_DATABASE_ALLOWLIST NOTION_POLL_SECONDS NOTION_BACKFILL_DAYS
)
